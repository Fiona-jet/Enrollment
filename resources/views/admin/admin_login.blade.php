...
@endif
              ...
              <form action="adminlogin" method="POST">
                ...
                @csrf
                  ...
                  <input type="text" name="admin_email" placeholder="email" class="form-control p_input">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="text" name="admin_password" placeholder="password" class="form-control p_input">
                </div>
